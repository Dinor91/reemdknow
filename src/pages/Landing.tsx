          ...
          <div className="container mx-auto px-4 text-center">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                מוצרים שנבחרו בקפידה, נבדקו אישית, ומומלצים על ידי קהילה של ישראלים<br />
                    ...
                    <div className="text-center space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-muted-foreground text-lg">
                          המלצות אמיתיות מ-Lazada
                        </p>
                      </div>

                      <div className="bg-muted p-4 rounded-lg">
                        <p className="text-sm text-foreground">
                          ✨ מוצרים שנבחרו על ידי ישראלים בתאילנד<br />
                          🚀 משלוחים מהירים<br />
                          💎 מחירים משתלמים
                        </p>
                      </div>
                  ...
                  <CardContent className="p-8">
                    <div className="text-center space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-muted-foreground text-lg">
                          המלצות אמיתיות מ-AliExpress
                        </p>
                      </div>

                      <div className="bg-muted p-4 rounded-lg">
                        <p className="text-sm text-foreground">
                          ✨ מוצרים שנבדקו על ידי משפחה וחברים<br />
                          🎉 מבצעים מיוחדים<br />
                          💪 איכות מובטחת
                        </p>
                      </div>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <p className="text-muted-foreground">
                    כל מוצר נבדק על ידי אנשים אמיתיים מהקהילה
                  </p>
                </div>
                ...
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <p className="text-muted-foreground">
                    קבוצות ווטסאפ וטלגרם פעילות עם מאות משתמשים
                  </p>
                </div>
                ...
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <p className="text-muted-foreground">
                    מוצרים חדשים ומבצעים מתעדכנים באופן קבוע
                  </p>
                </div>
              </div>
              ...
              <div className="bg-primary/10 p-8 rounded-lg border-2 border-primary/20 mt-12">
                ...
                <p className="text-lg text-muted-foreground">
                  לחסוך לכם זמן, כסף וכאב ראש בחיפוש אחר מוצרים איכותיים<br />
