          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl font-semibold bg-gradient-to-r from-primary via-purple-500 to-pink-500 bg-clip-text text-transparent animate-fade-in">
                                                                              ✨
 ממש בקרוב יופיעו כאן ריכוז המלצות
 שוות                                                                                                                                                                                                                                                                                 
              </p>
              <a href="https://s.click.aliexpress.com/e/_c4WQp8zf" target="_blank" rel="noopener noreferrer" className="inline-block mt-6 text-lg font-bold text-primary hover:text-primary/80 transition-all duration-300 hover:scale-105 underline decoration-2 underline-offset-4">
