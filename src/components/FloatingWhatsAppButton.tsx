...
export const FloatingWhatsAppButton = ({ country }: FloatingWhatsAppButtonProps) => {
  ...
  const telegramLink = country === "israel"
    ? "https://t.me/+5I2lR9VPmjBmNTE0"
    : "https://t.me/+xQ0OEwN4dhgyNzg8";
  ...
  const handleTelegramClick = () => {
    trackTelegramClick(`${country}_floating`);
    trackFBLead(`Telegram Float - ${country}`);
    trackButtonClick("telegram", `${country}_floating`, country);
    setIsOpen(false);
  };
  ...
  return (
    <div ref={containerRef} className="fixed bottom-6 left-6 z-50">
      {/* Menu */}
      <div 
        className={`absolute bottom-16 left-0 bg-card rounded-xl shadow-2xl border border-border overflow-hidden min-w-[160px] transition-all duration-300 ${
          isOpen 
      ...
      >
        <a
          ...
          className="flex items-center gap-3 px-4 py-3 text-foreground hover:bg-green-50 dark:hover:bg-green-950 transition-colors border-b border-border"
        >
        ...
        <a
          ...
          className="flex items-center gap-3 px-4 py-3 text-foreground hover:bg-blue-50 dark:hover:bg-blue-950 transition-colors"
        >
      ...
      <Button
        ...
        className={`h-14 w-14 rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] hover:from-[#128C7E] hover:to-[#25D366] text-white shadow-2xl transition-all duration-300 ${
