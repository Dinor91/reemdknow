      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="text-center text-xl md:text-2xl font-semibold mb-4" style={{ color: "#41b5b3" }}>
            <span className="hidden md:inline">?איפה אתה רוצה לקבל את ההמלצות הכי חמות</span>
            <span className="block md:hidden">איפה אתה רוצה לקבל את ההמלצות</span>
            <span className="block md:hidden">?הכי חמות</span>
          </p>
