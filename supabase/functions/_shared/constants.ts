...
export const LAZADA_CATEGORY_MAP: Record<string, number[]> = {
  'גאדג׳טים ובית חכם': [42062201, 3835, 3836, 10100245, 3834, 3990, 10100380, 10100387, 10100412, 10100871],
  'רכב ותחבורה':       [8428],
  'בית ומטבח':         [3833, 11829, 62541004, 11828],
  'אופנה וסטייל':      [3008, 5955],
  'ילדים ומשחקים':     [5095, 5090],
  'בריאות וספורט':     [10100869, 5761],
  'כלי עבודה וציוד':   [11830, 11833],
};
